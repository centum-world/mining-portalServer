...
//           console.log(typeof(miningPartner),930)

//           const {p_liquidity}= miningPartner
//           console.log(p_liquidity,1404)

//   const liquidity = miningPartner.p_liquidity;
//   console.log(liquidity, 930);

//   const phone = miningPartner.p_phone;
//   const referredIdOfPartner = miningPartner.p_reffered_id;
//   console.log(referredIdOfPartner, 932);

//   // Your other code...
// } else {
//   console.log("miningPartner is not defined or is an empty array", 936);
//   // Handle the case when miningPartner is not defined or is an empty array
// }
...
//       const findPartnerQuery = "SELECT * FROM mining_partner WHERE p_refferal_id = ?";
//       const [partnerResult] = await connection
//         .promise()
//         .query(findPartnerQuery, [referredIdOfPartner]);
