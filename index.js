...
const adminFetchLiquidityDetailsForActivePartners = require('./routes/admin-fetch-liquidity-details-for-active-partners');
...
app.use('/admin',adminFetchLiquidityDetailsForActivePartners);
